...
var _CertProofStore = require("./stores/CertProofStore");

var _CertProofStore2 = _interopRequireDefault(_CertProofStore);
...
var CertProof = {
	...
	setData: function setData(data) {
		// update store data
		_CertProofStore2.default.setData(data);
	},
	loadComponent: function loadComponent(data) {
		this.data = data;
		...
		this.certProofStore = _CertProofStore2.default;

		_reactDom2.default.render(_react2.default.createElement(_AppRoutes2.default, { certProofStore: this.certProofStore, mainComp: this }), document.getElementById(data.containerId));
	},
	// destroy reactJs component
	destroyTaskRefsComponent: function destroyTaskRefsComponent(id) {
...
},{"./components/AppRoutes":3,"./stores/CertProofStore":12,"react":"react","react-dom":"react-dom"}],1:[function(require,module,exports){
'use strict';
...
exports.default = {
	favIcon: "style/imgs/cert.PNG",
	appIcon: "style/imgs/certcomm-logo.png",
	zipIcon: "style/imgs/interface.png",
	governorIcon: "style/imgs/governor.png",
	noImage: "style/imgs/no_image.jpg",
	roleImage: "style/imgs/role_human.jpg"
};
...
var _UploadEvidence = require('./UploadEvidence');

var _UploadEvidence2 = _interopRequireDefault(_UploadEvidence);
    ...
    _createClass(AppRoutes, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'wrapper' },
                !isUploadedEvidence ? _react2.default.createElement(_UploadEvidence2.default, { certProofStore: this.store, mainComp: this.props.mainComp }) : _react2.default.createElement(_Dashboard2.default, { certProofStore: this.store, mainComp: this.props.mainComp })
            );
        }
    }]);
...
},{"./../../config/constants.js":1,"./Dashboard":4,"./UploadEvidence":11,"mobx-react":24,"react":"react"}],4:[function(require,module,exports){
"use strict";
...
var _Thread = require("./Thread/js/components/Thread");
...
var AppRoutes = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    _createClass(AppRoutes, [{
        ...
        value: function configSectionModal() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { id: "modal-content-container", className: "modal-content" },
                        _react2.default.createElement(
                            "div",
        ...
        */
        ...
        key: "updateSectionToAddFileName",
        value: function updateSectionToAddFileName(changesetjson, currentchangeset, zipentryname, isForwarded) {
            ...
            if (header != "") {
                ...
                if (currentChangeSetSections && Object.keys(currentChangeSetSections).length > 0) currentChangeSetSections.map(function (cssection, i) {
                    if (!cssection.zipEntryName) cssection.zipEntryName = zipentryname;

                    if (headerSections) headerSections.map(function (hsection, i) {
                ...
                });else if (headerSections && isForwarded === true) headerSections.map(function (hsection, i) {
                    if (!hsection.zipEntryName) hsection.zipEntryName = zipentryname;
                });
            }
        ...
        key: "updateAttachmentsToAddFileName",
        value: function updateAttachmentsToAddFileName(changesetjson, currentchangeset, zipentryname) {
            var attachments = currentchangeset.attachments;

            if (attachments) attachments.map(function (attachment, i) {
        ...
        key: "updateWriterImages",
        value: function updateWriterImages(params) {
            ...
            if (header && header.writers) {
                header.writers.map(function (hwriter, i) {
            ...
            if (currentchangeset.creator) if (writerimagemappings[currentchangeset.creator.foreverTmailAddress]) {
            ...
            if (currentchangeset.addedWriters && currentchangeset.addedWriters.length > 0) currentchangeset.addedWriters.map(function (cwriter, i) {
        ...
        key: "readManifestJson",
        value: function readManifestJson(params) {
            var _this3 = this;
            ...
            */
            ...
            if (bufferData != null) {
                ...
                if (!changesetJson.header && !jsonData.metadataDeleted) {
                    ...
                    changesetJson.header.writers.map(function (writer, i) {
                ...
                if (jsonData.forwards) {
                    ...
                    var forwards = [];
                    jsonData.forwards.map(function (forward) {
                        ...
                        for (var i = forward.forwardedAtChangeNum; i > 0; i--) {
                            ...
                            };forwardedChangesetJson = _this3.readManifestJson(params);
                        }
                        //});
                ...
                try {
                    ...
                    if (incManifestJson.writerImageMappings) {
                        var writersImages = {};
                        incManifestJson.writerImageMappings.map(function (writer, i) {
                            try {
        ...
        key: "accessChildZip",
        value: function accessChildZip(json) {
            var _this4 = this;
            ...
            var t = function t(cnum) {
                ...
                if (_this4.entries[filename] == undefined) {
                    filename = "L1_INC_EV_" + ttn + "_" + cnum + ".zip";
                    var zipEntry = _this4.entries[filename];
                } else {
                    var zipEntry = _this4.entries[filename];
                }
        ...
        key: "readEvidence",
        value: function readEvidence(filename, filepath) {
            var _this5 = this;
            ...
            zip.on('ready', function () {
                ...
                zip.extract(null, Constants.default.extractedEvidenceFolder, function (err, count) {
                    if (err) console.log('Extract error ' + err);

                    // get data only from {`Constants.default.routeEvidenceJsonFileName`} file
                    if (_this5.entries[Constants.default.errorFileName]) {
                        var bufferErrorData = zip.entryDataSync(Constants.default.errorFileName);
                        var errData = bufferErrorData.toString('utf-8');
                        _this5.store.setError("Error " + errData);
                    } else {
                        if (_this5.entries[Constants.default.routeEvidenceJsonFileName]) {
                            ...
                            // access child zip
                            _this5.accessChildZip(jsonData);
                        } else {
                            _this5.store.setError("Missing " + Constants.default.routeEvidenceJsonFileName + " file.");
                        }
                    }
        ...
        value: function copyEvidence() {
            ...
            if (filepath) {
                ...
                source.on('end', function () {
                    ...
                    _this6.readEvidence(filename, filepath);
                });
        ...
        value: function checkProveEvidence() {
            ...
            setTimeout(function () {
                if (_this7.state.progress < 100) {
                    _this7.checkProveEvidence();
                } else {
                    setTimeout(function () {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "xpanel-header" },
                        _react2.default.createElement(
                            "div",
                            { className: "logo fl" },
                            _react2.default.createElement("img", { className: "logo", src: ConfigImages.default.appIcon, alt: "CertComm", title: "CertComm" })
                        ),
                        _react2.default.createElement(
                            "div",
                            { className: "xpanel-header-back-btn" },
                            _react2.default.createElement(
                                "button",
                                { className: "btn btn-breadcrumb", onClick: this.navigateToUploadEvidence.bind(this) },
                                "\u276E Back"
                            )
                        )
                    ),
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            governor ? _react2.default.createElement(
                                "div",
                                { className: "xpanel-info-sub-container", title: "CertComm governor of this " + (isCertified ? "certified" : "") + " thread" },
                                _react2.default.createElement("img", { className: "dashboard-icon", src: ConfigImages.default.governorIcon, alt: "CertComm governor of this " + (isCertified ? "certified" : "") + " thread", title: "CertComm governor of this " + (isCertified ? "certified" : "") + " thread" }),
                                _react2.default.createElement(
                                    "span",
                                    { className: "zip-file-name" },
                                    governor
                                ),
                                evidenceData.governorLogoExtension ? _react2.default.createElement("img", { className: "dashboard-icon margin-between", src: Constants.default.extractedEvidenceFolder + "governorLogo." + evidenceData.governorLogoExtension, alt: governor, title: governor }) : null
                            ) : null,
                            _react2.default.createElement(
                                "div",
                                { className: "xpanel-info-sub-container", title: "Current Evidence File: " + storeFileName },
                                _react2.default.createElement(
                                    "span",
                                    { className: "zip-file-name" },
                                    storeFileName
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        "div",
                                        { className: "col fancy", onClick: this.toggleSlider.bind(this, "hide-me") },
                                        _react2.default.createElement(
                                            "span",
                                            null,
                                            "More Details"
                                ...
                                _react2.default.createElement(
                                    "div",
                                    { className: "advanced-sub-container hide-me hidden" },
                                    _react2.default.createElement(
                                        "div",
                                        { className: "info-label" },
                                        "CertProof App Version"
                                    ),
                                    _react2.default.createElement(
                                        "div",
                                        { className: "fl bold" },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "verification-container hidden" },
                                _react2.default.createElement(
                                    "div",
                ...
                _react2.default.createElement(
                    "div",
                    { className: "ypanel" },
                    _react2.default.createElement(_Thread2.default, { key: "thread-" + err, data: data, err: err })
                ),
...
var Attachments = function (_React$Component) {
    ...
    function Attachments(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Attachments.__proto__ || Object.getPrototypeOf(Attachments)).call(this, props));
    ...
    _createClass(Attachments, [{
        ...
        key: 'openModal',
        value: function openModal(attachment) {
        ...
        key: 'configAttachmentModal',
        value: function configAttachmentModal() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'fl modal-attachment-title' },
                            attachment.title
                        ),
                        _react2.default.createElement('div', { className: 'fr btn-close', onClick: this.closeModal }),
                        _react2.default.createElement('div', { onClick: this.downloadAttachment.bind(this, attachment.title, attachment.content), className: 'fr download-s' })
                    ),
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'reset-css comment-text' },
                            _react2.default.createElement('img', { src: "data:application/octet-stream;charset=utf-16le;base64," + attachment.content })
                        )
                    )
                )
            );
        ...
        key: 'checkViewableFile',
        value: function checkViewableFile(filtExt) {
            switch (filtExt) {
                case 'jpg':
                case 'jpeg':
                case 'gif':
        ...
        value: function downloadAttachment(filename, content) {
        ...
        key: 'viewAttachment',
        value: function viewAttachment(attachment) {
            var _this2 = this;
            ...
            zip.on('ready', function () {
                try {
                    var ext = _this2.bifFileName(attachment.title).ext,
                ...
                if (bufferData != null) {
                    ...
                    if (!_this2.checkViewableFile(ext)) {
                        _this2.downloadAttachment(attachment.title, manifestJson);
                    } else {
                        _this2.openModal(attachment);
                    }
                }
                zip.close();
            });
        ...
        key: 'bifFileName',
        value: function bifFileName(fileName) {
        ...
        key: 'getAttachments',
        value: function getAttachments(attachments) {
            var _this3 = this;

            if (attachments && attachments.length > 0) {
                return attachments.map(function (file, i) {
                    var f = _this3.bifFileName(file.title),
                        fileType = f.ext;

                    var attachmentNumHtml = "";
                    if (typeof file.attachmentNum != "undefined") {
                        attachmentNumHtml = _react2.default.createElement(
                            'div',
                            { className: 'comment-attachment-file-num' },
                            _react2.default.createElement(
                                'span',
                                { className: 'comment-attachment-num' },
                                "#" + file.attachmentNum
                            )
                        );
                    }
                    ...
                    return _react2.default.createElement(
                        'div',
                        { className: '-comment-attachment-container x-attachments', key: "atachment-container-" + i },
                        _react2.default.createElement(
                            'div',
                            { className: 'comment-attachment' },
                            _react2.default.createElement('div', { className: 'add-attachment left' })
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'comment-attachment-right' },
                            attachmentNumHtml,
                            _react2.default.createElement(
                                'div',
                                { className: 'comment-attachment-file-icon' },
                                _react2.default.createElement('span', { className: "t-file-icon-16 t-file-icon-16-" + fileType + " left" })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'comment-attachment-name' },
                                _react2.default.createElement(
                                    'a',
                                    { onClick: _this3.viewAttachment.bind(_this3, file), className: 'section-title' },
                                    file.title,
                                    ' '
                                )
                            ),
                            _react2.default.createElement('div', { className: 'comment-attachment-size' })
                        )
                    );
                });
            } else {
...
var Comments = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    _createClass(Comments, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                Object.keys(comments).reverse().map(function (i) {
                    var comment = comments[i];
                    if (typeof comment == "string") {
                        return _react2.default.createElement(
                            "div",
                            { className: "item-wrapper", key: "item-wrapper-" + Math.random() },
                            _react2.default.createElement(
                                "div",
                                { className: "forwarded-comment-deleted" },
                                comment
                            )
                        );
                        ...
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "forwarded-header-deleted" },
                                "#",
                                comment.changeNum,
                                ": Comment Header Deleted"
                            ),
                            comment.comment ? _react2.default.createElement(
                                "div",
                                { className: "comment-container" },
                                _react2.default.createElement("div", { className: "comment-text", dangerouslySetInnerHTML: { __html: comment.comment } })
                            ) : null
                        );
                    } else {
                        var commentDate = comment.creationTimestamp,
                            currentYear = new Date().getFullYear(),
                            commentDateYear = (0, _moment2.default)(comment.creationTimestamp).format('YYYY'),
                            currentTimeZone = _momentTimezone2.default.tz.guess(),
                            dateWithNewTimeZone = _moment2.default.tz(commentDate, currentTimeZone),
                            dateWithNewTimeZone = dateWithNewTimeZone.valueOf(),
                            formatedDate = (0, _moment2.default)(dateWithNewTimeZone).calendar(null, {
                            sameDay: '[Today] LT',
                        ...
                        if (comment.changeType == "ack_read") {
                            var commentHTML = _react2.default.createElement(
                                "div",
                                { className: "comment-text-ack" },
                                _react2.default.createElement(
                                    "div",
                                    { className: "comment-text" },
                                    "I acknowledge that I have read Comments."
                                ),
                                _react2.default.createElement("div", { title: "Read acknowledgement", className: "ack-certified-read" })
                            );
                            ...
                            var commentHTML = _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    "div",
                                    { className: "comment-text" },
                                    "I acknowledge that I have received Comments."
                                ),
                                _react2.default.createElement("div", { title: "Explicit Receipt acknowledgement", className: "ack-certified" })
                            );
                        } else {
                            var commentHTML = _react2.default.createElement("div", { className: "comment-text", dangerouslySetInnerHTML: { __html: comment.comment } });
                        }
                        return _react2.default.createElement(
                            "div",
                            { className: "item-wrapper", key: "item-wrapper-" + comment.changeNum },
                            _react2.default.createElement(
                                "div",
                                { className: "detail-data" },
                                _react2.default.createElement(_Writers2.default, { key: Math.random(), data: [comment.creator] }),
                                _react2.default.createElement(
                                    "div",
                                    { className: "contribute-data" },
                                    _react2.default.createElement(
                                        "div",
                                        { className: "contribute-info" },
                                        _react2.default.createElement(
                                            "div",
                                            { className: "num" },
                                            "#",
                                        ...
                                        _react2.default.createElement(
                                            "div",
                                            { className: "writer-nm" },
                                            comment.creator ? comment.creator.firstName + " " + comment.creator.lastName : ""
                                        ),
                                        _react2.default.createElement(
                                            "span",
                                            { title: tooltipDate },
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "comment-container" },
                                _react2.default.createElement(_Sections2.default, { key: Math.random(), sections: comment.sections, data: _this2.data }),
                                _react2.default.createElement(_Attachments2.default, { key: Math.random(), data: comment.attachments }),
                                _react2.default.createElement(
                                    "div",
                                    { className: "added-writer-container" },
                                    _react2.default.createElement(_Writers2.default, { key: Math.random(), data: comment.addedWriters, type: "added" })
                                ),
                                commentHTML
                            )
                        );
...
},{"./Attachments":5,"./Sections":7,"./Writers":9,"mobx-react":24,"moment":29,"moment-timezone":27,"react":"react"}],7:[function(require,module,exports){
'use strict';
...
var Sections = function (_React$Component) {
    ...
    _createClass(Sections, [{
        ...
        key: 'openModal',
        value: function openModal(section) {
        ...
        value: function configSectionModal() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: section.type == "file" ? "modal-file-container" : "modal-container" },
                    _react2.default.createElement(
                        'div',
                        { className: 'modal-header' },
                        _react2.default.createElement(
        ...
        key: 'bifTmailAddress',
        value: function bifTmailAddress(address) {
        ...
        key: 'getsectionTypeMap',
        value: function getsectionTypeMap(type, sectionType) {
            switch (type) {
        ...
        key: 'writeAsExcel',
        value: function writeAsExcel(json, cb) {
            // set saved path
            ...
            if (json.rightmost_col_with_data && json.rightmost_col_with_data > 10) columns = json.rightmost_col_with_data;

            if (json.bottommost_row_with_data && json.bottommost_row_with_data > 15) rows = json.bottommost_row_with_data;
            ...
            // Fill some data
            if (dataLength > 0) for (var i = 0; i < dataLength; i++) {
            ...
            if (json.columns && json.columns.length > 0) for (var i = 0; i < json.columns.length; i++) {
                worksheet.column(json.columns[i][0] + 1).setWidth(json.columns[i][1] / 7);
            }

            // set changed row height
            if (json.rows && json.rows.length > 0) for (var i = 0; i < json.rows.length; i++) {
            ...
            if (formatStack && formatStack.length > 0) {
                ...
                for (var i = 0; i < formatStack.length; i++) {
                    var setFormat = function setFormat(col, row, prop, val) {
                        var obj = "";
                        ...
                        row = Number(row) + 1;
                        try {
                            if (obj != "") worksheet.cell(col, row).style(workbook.createStyle(obj));
                        } catch (e) {
                            console.log("Error: , ", e);
                        }
                    };
        ...
        key: 'viewSection',
        value: function viewSection(section) {
            var _this2 = this;
            ...
            zip.on('ready', function () {
                ...
                if (bufferData != null) {
                    ...
                    if (section.type == 'file') {
                        ...
                        _this2.writeAsExcel(JSON.parse(dataJson), function (r) {
                            // download the file
                        ...
                        sectionContent = _this2.urlify(sectionContent);
                    }
        ...
        key: 'viewFile',
        value: function viewFile(section) {
            var _this3 = this;
            ...
            zip.on('ready', function () {
                try {
                    var ext = _this3.bifFileName(section.fileSectionOriginalName).ext,
                ...
                if (bufferData != null) {
                    // convert buffer data into string (utf-8)
                    var manifestJson = bufferData.base64Slice();
                    _this3.downloadFile(section.fileSectionOriginalName, manifestJson);
                }
                zip.close();
            });
        }
        ...
        key: 'getSections',
        value: function getSections(sections) {
            var _this4 = this;

            if (sections && sections.length > 0) {
                var sectionHTML = sections.map(function (section, i) {
                    var sectionTypeCls = _this4.getsectionTypeMap("sectionTypeCssMap", section.type),
                        sectionTypeTitle = _this4.getsectionTypeMap("sectionTypeTitleMap", section.type),
                        fileTypeIconCls = "",
                        templateSectionColor = '';

                    if (section.fromTemplate || section.isTemplateDescription) {
                        templateSectionColor = 'templateSectionColor';
                    }

                    var actionFunc = _this4.viewSection.bind(_this4, section);

                    if (section.type == 'file') {
                        //actionFunc = this.viewFile.bind(this, section);
                        if (section.fileSectionState == 'BOUND') {
                            var fileExt = _this4.bifFileName(section.fileSectionOriginalName).ext;
                            sectionTypeTitle = 'File of type ' + fileExt;
                            fileTypeIconCls = 't-file-icon-16 t-file-icon-16-' + fileExt;

                            if (!_this4.checkViewableFile(fileExt)) {
                                actionFunc = _this4.viewFile.bind(_this4, section);
                            }
                        } else {
                    ...
                    if (_this4.type == "list") {
                        return _react2.default.createElement(
                            'div',
                            { key: "section-el-" + i + "-" + _this4.type, className: "section-el " + templateSectionColor },
                            _react2.default.createElement('span', { className: sectionTypeCls + " " + fileTypeIconCls + " icon16x16 fl", title: sectionTypeTitle }),
                            _react2.default.createElement(
                                'a',
                                { title: section.title },
                                _react2.default.createElement(
                                    'div',
                                    { onClick: actionFunc, className: 'fl section-title' },
                                    section.title
                                )
                            )
                        );
                        ...
                        switch (section.sectionChangeType) {
                            ...
                            case 'added':
                                return _react2.default.createElement(
                                    'div',
                                    { className: "-comment-section-container " + templateSectionColor, key: "section-container-" + i },
                                    _react2.default.createElement(
                                        'div',
                                        { className: '-comment-section-action' },
                                        _react2.default.createElement('span', { className: 't-add icon16x16', title: 'Created', style: { 'marginLeft': '5px' } })
                                    ),
                                    _react2.default.createElement(
                                        'div',
                                        { className: '-comment-section-tittle' },
                                        _react2.default.createElement(
                                            'div',
                                            { className: '-comment-section-icon' },
                                            _react2.default.createElement('span', { className: sectionTypeCls + ' ' + fileTypeIconCls + ' icon16x16 left', title: sectionTypeTitle })
                                        ),
                                        _react2.default.createElement(
                                            'div',
                                            { onClick: actionFunc, className: 'section-title' },
                                            section.title
                                        )
                                    )
                                );
                            ...
                            case 'updated':
                                ...
                                return _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        { className: '-comment-section-action' },
                                        _react2.default.createElement('span', { className: 't-changed icon16x16', title: 'Updated', style: { 'marginLeft': '5px' } })
                                    ),
                                    _react2.default.createElement(
                                        'div',
                                        { className: '-comment-section-tittle' },
                            ...
                            case 'deleted':
                                return _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        { className: '-comment-section-action' },
                                        _react2.default.createElement('span', { className: 't-deleted icon16x16', style: { 'marginLeft': '5px' } })
                                    ),
                                    _react2.default.createElement(
                                        'div',
                                        { className: '-comment-section-tittle' },
                                        ...
                                        _react2.default.createElement(
                                            'div',
                                            { className: 'disable-section-title' },
                                            section.title
                                        )
                                    )
                                );
...
var _ThreadStore = require('./../stores/ThreadStore');
...
var Thread = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    function Thread(props) {
        ...
        _this.store = _ThreadStore2.default;
        _this.data = props.data;
        _this.err = props.err;
        return _this;
    }
    ...
    _createClass(Thread, [{
        ...
        value: function componentDidUpdate() {
            ...
            if (typeof element != 'undefined' && element != null && element.length > 0) {
                var ps = new _perfectScrollbar2.default('.middle-container');
                ps.update();
            }
        }
    }, {
        key: 'renderComments',
        value: function renderComments(data, headerData, isForwarded) {
            return _react2.default.createElement(
                'div',
                null,
                headerData && headerData.sections && headerData.sections.length > 0 ? _react2.default.createElement(
                    'div',
                    { className: 'section-header-container' },
                    _react2.default.createElement(_Sections2.default, { key: "section-header-container" + Math.random(), sections: headerData.sections, data: headerData, type: 'list' })
                ) : null,
                _react2.default.createElement(_Comments2.default, { comments: data.comments, data: headerData, store: this.store })
            );
        }
    }, {
        key: 'renderHeader',
        value: function renderHeader(headerData, isForwarded) {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        headerData.ttn ? _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'fl ttno', title: headerData.ttn },
                                '[',
                                headerData.ttn.split('-')[2],
                                ']'
                            ),
                            _react2.default.createElement(
                                'div',
                                { id: 'clip-tmail-link', className: 'hidden' },
                                ttnLink
                            ),
                            !isForwarded ? _react2.default.createElement(
                                ...
                                _react2.default.createElement('div', { className: 'x-btn t-url-icon zclips' })
                            ) : null
                        ) : null,
                        headerData.templateParent || headerData.threadType == "Instance" ? _react2.default.createElement('div', { title: 'Instance, instantiated from smart template "' + headerData.templateParent.parentTemplateName + '" Release ' + headerData.templateParent.releaseNum, className: 't-instance fr toolbar-btn' }) : null,
                        headerData.threadType == "Template" ? _react2.default.createElement('div', { title: (headerData.certified ? "Certified" : "") + " Smart Template", className: 't-template fr toolbar-btn' }) : null
                    )
                ),
                _react2.default.createElement('div', { className: 'clear' }),
                headerData.writers && headerData.writers.length > 0 ? _react2.default.createElement(
                    'div',
                    { className: 'writer-header-container' },
                    _react2.default.createElement(_Writers2.default, { key: "writer-header-container+" + Math.random(), data: headerData.writers, type: isForwarded ? "" : "list" })
                ) : null
            );
        }
    }, {
        ...
        value: function renderThread() {
            ...
            if (data.forwards) {
                ...
                forwardedCommentHtml = data.forwards.map(function (forward) {
                    ...
                    * */
                    Object.keys(fcm).map(function (i) {
                        var updateComments = function updateComments(sD, eD, obj, index) {
                            if (sD != "") {
                                if (sD == 1 && eD != "") {
                                    if (isCertifiedForward) obj[index - 1] = "All forwarded comments below deleted";else obj[index - 1] = "All #" + eD + "'s below deleted";
                                } else if (sD != "" && eD != "") {
                    ...
                    return _react2.default.createElement(
                        'div',
                        { className: 'forwarded-item-wrapper', key: Math.random() },
                        _this2.renderHeader(forward.header, true),
                        _this2.renderComments(forward, forward.header, true)
                    );
                });
                forwardedCommentHtml = _react2.default.createElement(
                    'div',
                    { className: 'forwarded-container' },
                    _react2.default.createElement(
                        'div',
                        { className: 'more' },
                        _react2.default.createElement(
                            'div',
                            { className: 'col', onClick: this.toggleSlider.bind(this, "hide-forwarded-container") },
                            isCertifiedForward ? _react2.default.createElement(
                                'span',
                                null,
                                'Certified Forwarded Comments',
                                _react2.default.createElement('div', { className: 'fl tmail-certified-new-rhs', title: 'This thread is certified' })
                            ) : _react2.default.createElement(
                                'span',
                                null,
                                ' Forwarded Comments '
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'hide-forwarded-container' },
                        forwardedCommentHtml
                    )
                );
            }

            return err != "" ? _react2.default.createElement(
                'div',
                { key: Math.random(), className: 'blank-container' },
                _react2.default.createElement(
                    'div',
                    { className: 'information-message' },
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'information-danger-message' },
                    err
                )
            ) : _react2.default.createElement(
                'div',
...
},{"./../stores/ThreadStore":10,"./Comments":6,"./Sections":7,"./Writers":9,"mobx-react":24,"perfect-scrollbar":31,"react":"react","react-clipboard.js":38}],9:[function(require,module,exports){
'use strict';
...
var Writers = function (_React$Component) {
    _inherits(Writers, _React$Component);

    function Writers(props) {
        _classCallCheck(this, Writers);

        var _this = _possibleConstructorReturn(this, (Writers.__proto__ || Object.getPrototypeOf(Writers)).call(this, props));
    ...
    _createClass(Writers, [{
        key: 'getFirstLetter',
        value: function getFirstLetter(v) {
            var vArr = v.split(" ");
        ...
        key: 'getWritersInitials',
        value: function getWritersInitials(writers) {
            var _this2 = this;

            if (writers && (typeof writers === 'undefined' ? 'undefined' : _typeof(writers)) == 'object') {
                // For array writers object
                writers.map(function (val, key) {
                    if (val.firstName && val.firstName != '') {
                        var name = val.firstName + " " + val.lastName;
                        writers[key]['firstInitials'] = _this2.getFirstLetter(name);
                        writers[key]['initial'] = _this2.getFirstLetter(name);
                    } else {
        ...
        key: 'compileWriterTooltip',
        value: function compileWriterTooltip(writer, index) {
            writer.toolTip = true;
            writer.view = "list";
            return _react2.default.createElement(
                'div',
                { className: 'actorsHoverView' },
                _react2.default.createElement(
                    'div',
                    { className: 'ahv-wrapper' },
                    _react2.default.createElement(
                        'ul',
                        { className: 'actors-writer writers-wrapper2' },
                        this.compileWriterObject(writer, index)
                    )
                )
            );
        }
        ...
        key: 'compileWriterObject',
        value: function compileWriterObject(writer, index) {
            var tooltipKey = writer.contemporaneousTmailAddress + "-" + index + "-" + Math.random();
            var writerHTML = _react2.default.createElement(
                'li',
                { 'data-tip': true, 'data-for': tooltipKey, className: 'writer-rounded w-list-view my-org' },
                writer.role !== true && writer.bindEmailAddress == undefined ? writer.profileImage ? _react2.default.createElement('img', { src: this.getUserImage(writer), className: 'img-circle m-t-xs img-responsive' }) : _react2.default.createElement(
                    'div',
                    { className: 'no-image' },
                    writer.firstInitials
                ) : "",
                writer.role === true || writer.bindEmailAddress ? _react2.default.createElement(
                    'div',
                    { className: "no-image " + (writer.role === true ? "role" : "email") },
                    writer.firstInitials
                ) : "",
                writer.view == "list" ? _react2.default.createElement(
                    'div',
                    { className: 'w-info' },
                    writer.firstName != undefined && writer.firstName != "" ? _react2.default.createElement(
                        'div',
                        { className: 'w-name' },
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'w-address' },
                        writer.contemporaneousTmailAddress
                    )
                ) : ""
            );
            ...
            if (writer.hover === true) {
                return _react2.default.createElement(
                    'div',
                    { key: "writer-hover-container-" + this.type + "-" + Math.random() },
                    writerHTML
                );
            } else {
                var qtip = null,
                    writerTooltipHtml = null;
                if (!writer.toolTip) {
                    qtip = this.compileWriterTooltip(writer, index);
                    writerTooltipHtml = _react2.default.createElement(
                        _reactTooltip2.default,
                        { className: 'tooltip-container', id: tooltipKey, type: 'light', effect: 'solid' },
                        qtip
                    );
                }
                ...
                return _react2.default.createElement(
                    'div',
                    { key: "writer-container-" + this.type + "-" + Math.random() },
                    writerHTML,
                    writerTooltipHtml
                );
            }
        ...
        key: 'getWriters',
        value: function getWriters(writers, type) {
            var _this3 = this;

            writers = this.getWritersInitials(writers);
            return writers.map(function (writer, i) {
                writer.view = "";
                writer.hover = false;
                if (type == "hover") {
                    writer.view = "list";
                ...
                return _this3.compileWriterObject(writer, i);
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            if (writers && writers.length > 0 && writers[0] != undefined) {
                ...
                if (this.type == "added") {
                    writerPrefixHtml = _react2.default.createElement('li', { className: 'added-writer t-add icon16x16' });
                } else if (this.type == "list" && writers.length > 1) {
                    writerPrefixHtml = _react2.default.createElement(
                        'div',
                        { 'data-tip': true, 'data-for': 'writers-header-tooltip' },
                        _react2.default.createElement(
                            'div',
                            { className: 'writers-count-wrapper' },
                            _react2.default.createElement(
                                'div',
                                { className: 'h-inner-wrapper' },
                                _react2.default.createElement('span', { className: 'h-users-icon' })
                            )
                        ),
                        _react2.default.createElement(
                            _reactTooltip2.default,
                            { className: 'tooltip-container', id: 'writers-header-tooltip', 'aria-haspopup': 'true', type: 'light', effect: 'solid', place: 'bottom' },
                            _react2.default.createElement(
                                'div',
                                { className: 'actorsHoverView' },
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'ul',
                                        { className: 'actors-writer writers-wrapper2 hover-list' },
...
var ThreadStore = exports.ThreadStore = (_class = function () {
	function ThreadStore() {
		_classCallCheck(this, ThreadStore);

		_initDefineProp(this, "thread", _descriptor, this);
	}
	...
	return ThreadStore;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "thread", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return {};
	}
})), _class);
exports.default = new ThreadStore();


},{"mobx":25}],11:[function(require,module,exports){
'use strict';
...
function UploadEvidenceView(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { className: 'single-line', type: 'text', placeholder: 'Please select a file', id: 'actual-file', disabled: 'disabled' }),
        _react2.default.createElement('input', { className: 'upload-button-radius btn btn-w-m', type: 'button', value: 'Upload Evidence', onClick: props.openDialog })
    );
}
...
function UploadedEvidenceView(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'form-group' },
            _react2.default.createElement('input', { className: 'single-line', type: 'text', placeholder: 'Please select a file', value: props.filename, disabled: 'disabled' }),
            _react2.default.createElement('input', { className: 'upload-button btn btn-w-m', type: 'button', value: 'Change', onClick: props.openDialog }),
            _react2.default.createElement('input', { className: 'upload-button-radius btn btn-w-m', type: 'button', value: 'Remove', onClick: props.removeEvidence })
        ),
        _react2.default.createElement(
            'div',
            { className: 'form-group' },
            _react2.default.createElement('input', { className: 'btn-success btn btn-w-m', type: 'button', value: 'Next', onClick: props.updateEvidenceProof })
        )
    );
}

var UploadEvidence = (0, _mobxReact.observer)(_class = function (_React$Component) {
    _inherits(UploadEvidence, _React$Component);

    function UploadEvidence(props) {
        _classCallCheck(this, UploadEvidence);

        var _this = _possibleConstructorReturn(this, (UploadEvidence.__proto__ || Object.getPrototypeOf(UploadEvidence)).call(this, props));

        _this.store = props.certProofStore;
        return _this;
    }

    _createClass(UploadEvidence, [{
        key: 'openDialog',
        value: function openDialog() {
            ...
            dialog.showOpenDialog(remote.getCurrentWindow(), {
                ...
                if (fileNames === undefined) {
                    ...
                    _this2.store.setUploadEvidenceDetails(filename, filepath);
                }
            });
        }
    }, {
        ...
        value: function updateEvidenceProof(e, dirPath) {
            /*
            ...
            * */
            ...
            } else this.store.setUploadedEvidenceFlag(true);
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'header' },
                    _react2.default.createElement('img', { src: ConfigImages.default.appIcon, alt: 'certProof', title: 'certProof' })
                ),
                uploadeEvidenveName == "" ? _react2.default.createElement(UploadEvidenceView, { openDialog: this.openDialog.bind(this) }) : _react2.default.createElement(UploadedEvidenceView, { openDialog: this.openDialog.bind(this), removeEvidence: this.removeEvidence.bind(this), updateEvidenceProof: this.updateEvidenceProof.bind(this), filename: uploadeEvidenveName })
            );
        }
    }]);
...
exports.default = UploadEvidence;


},{"./../../config/constants.js":1,"./../../config/images.js":2,"mobx-react":24,"react":"react"}],12:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.CertProofStore = undefined;
...
var CertProofStore = exports.CertProofStore = (_class = function () {
	function CertProofStore() {
		...
		_initDefineProp(this, 'evidenceManifestData', _descriptor3, this);

		_initDefineProp(this, 'uploadedEvidence', _descriptor4, this);

		_initDefineProp(this, 'uploadedFileName', _descriptor5, this);
	...
	_createClass(CertProofStore, [{
		...
		value: function setEvidenceManifestData(data) {
		...
		value: function setUploadedEvidenceFlag(isUploaded) {
		...
		value: function getEvidenceManifestData() {
		...
		key: 'getUploadedEvidenceFlag',
		value: function getUploadedEvidenceFlag() {
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, 'evidenceManifestData', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return {};
	}
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, 'uploadedEvidence', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return false;
	}
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, 'uploadedFileName', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return '';
	}
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, 'uploadedFilePath', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return '';
	}
...
exports.default = new CertProofStore();


},{"mobx":25}],13:[function(require,module,exports){
/*!
...
},{"./emptyFunction":19,"_process":32}],22:[function(require,module,exports){
/**
...
},{"./is":22,"delegate":17}],24:[function(require,module,exports){
;(function(global, factory) {
...
},{"mobx":25,"react":"react","react-dom":"react-dom"}],25:[function(require,module,exports){
(function (global){
...
},{"./lib/ReactPropTypesSecret":37,"_process":32,"fbjs/lib/invariant":20,"fbjs/lib/warning":21}],34:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":37,"fbjs/lib/emptyFunction":19,"fbjs/lib/invariant":20}],35:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":33,"./lib/ReactPropTypesSecret":37,"_process":32,"fbjs/lib/emptyFunction":19,"fbjs/lib/invariant":20,"fbjs/lib/warning":21,"object-assign":30}],36:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
