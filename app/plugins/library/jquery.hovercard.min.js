    ...
    $.fn.hovercard = function (options) {
        ...
        if ($('#css-hovercard').length <= 0) {
            var hovercardTempCSS = '<style id="css-hovercard" type="text/css">' +
                                    '.hc-preview { display:inline; }' +
                                    '.hc-name { font-weight:bold; position:relative; display:inline-block; }' +
                                    '.hc-details { left:-10px; margin-right:80px; text-align:left; font-family:Sans-serif !important; font-size:12px !important; color:#666 !important; line-height:1.5em; border:solid 1px #ddd; position:absolute;-moz-border-radius:3px;-webkit-border-radius:3px;border-radius:3px;top:-10px;padding:2em 10px 10px;-moz-box-shadow:5px 5px 5px #888;-webkit-box-shadow:5px 5px 5px #888;box-shadow:5px 5px 5px #888;display:none;word-wrap:break-word;max-width:250px;min-width:80px;}' +
        ...
        return this.each(function () {
            var obj = $(this);
			var alreadyHasObject = true;
            //wrap a parent span to the selected element
			if(!obj.parent().hasClass("hc-preview")) {
			...
			if(alreadyHasObject) {
				...
				obj.parent().find('.hc-details').remove();
			}
			...
			//}
            obj.closest(".hc-preview span, .hc-preview div").click(function () {
                    
                var $this = $(this).parent('.hc-preview');
			...
			$(document).mouseup(function (e) {
				var container = obj.parent('.hc-preview');
				if(container.length > 0) {
					if (!container.is(e.target) // if the target of the click isn't the container...
						&& container.has(e.target).length === 0) // ... nor a descendant of the container
					{
						$this = obj.parent('.hc-preview');
